...
var ciudades = [
	{ID:1, nombre:"Acapulco", image:"images/ciudades/acapulco.jpg"},
	{ID:2, nombre:"Ciudad de México", image:"images/ciudades/cdmx.jpg"},
	{ID:3, nombre:"Ciudad de México", image:"images/ciudades/cdmx2.jpg"},
	{ID:4, nombre:"Cholula", image:"images/ciudades/cholula.jpg"},
	{ID:5, nombre:"Guadalajara", image:"images/ciudades/guadalajara.jpg"},
	{ID:6, nombre:"Guanajuato", image:"images/ciudades/guanajuato.jpg"},
	{ID:7, nombre:"Monterrey", image:"images/ciudades/monterrey.jpg"},
	{ID:8, nombre:"Morelia", image:"images/ciudades/morelia.jpg"},
	{ID:9, nombre:"Oaxaca de Juarez", image:"images/ciudades/oaxaca.jpg"},
	{ID:10, nombre:"Pachuca", image:"images/ciudades/pachuca.jpg"},
	{ID:11, nombre:"San Cristobal de las Casas", image:"images/ciudades/sanCristobal.jpg"},
	{ID:12, nombre:"Tlaxcala", image:"images/ciudades/tlaxcala.jpg"},
	{ID:13, nombre:"Veracruz", image:"images/ciudades/veracruz.jpg"},
	{ID:14, nombre:"Cancún", image:"images/ciudades/cancun.jpg"},
	{ID:15, nombre:"Santiago de Querétaro", image:"images/ciudades/queretaro.jpeg"},
	{ID:16, nombre:"Tulum", image:"images/ciudades/tulum.jpg"},
...
while(respIncorrecta1==respCorrecta || ciudades[respIncorrecta1].nombre==ciudades[respCorrecta].nombre){
	respIncorrecta1 = generateRandomNumber(0, (16-1));
}
while(respIncorrecta2==respCorrecta || respIncorrecta2==respIncorrecta1 || ciudades[respIncorrecta2].nombre==ciudades[respCorrecta].nombre || ciudades[respIncorrecta2].nombre==ciudades[respIncorrecta1].nombre){
	respIncorrecta2 = generateRandomNumber(0, (16-1));
}
while(respIncorrecta3==respCorrecta || respIncorrecta3==respIncorrecta1 || respIncorrecta3== respIncorrecta2|| ciudades[respIncorrecta3].nombre==ciudades[respCorrecta].nombre || ciudades[respIncorrecta3].nombre==ciudades[respIncorrecta1].nombre || ciudades[respIncorrecta3].nombre==ciudades[respIncorrecta2].nombre){
	respIncorrecta3 = generateRandomNumber(0, (16-1));
}

console.log(ciudades[respCorrecta]);
console.log(ciudades[respIncorrecta1]);
console.log(ciudades[respIncorrecta2]);
console.log(ciudades[respIncorrecta3]);

//changes right image
document.getElementById("img").src=ciudades[respCorrecta].image;
...
if (questionRand==1) {
	question.innerHTML = "What is the name of this city?";
	if(rightButton==1){
		btn1.innerHTML = ciudades[respCorrecta].nombre;
		btn2.innerHTML = ciudades[respIncorrecta1].nombre;
		btn3.innerHTML = ciudades[respIncorrecta2].nombre;
		btn4.innerHTML = ciudades[respIncorrecta3].nombre;
	}else if(rightButton==2){
		btn1.innerHTML = ciudades[respIncorrecta1].nombre;
		btn2.innerHTML = ciudades[respCorrecta].nombre;
		btn3.innerHTML = ciudades[respIncorrecta2].nombre;
		btn4.innerHTML = ciudades[respIncorrecta3].nombre;
	}else if(rightButton==3){
		btn1.innerHTML = ciudades[respIncorrecta1].nombre;
		btn2.innerHTML = ciudades[respIncorrecta2].nombre;
		btn3.innerHTML = ciudades[respCorrecta].nombre;
		btn4.innerHTML = ciudades[respIncorrecta3].nombre;
	}else if(rightButton==4){
		btn1.innerHTML = ciudades[respIncorrecta1].nombre;
		btn2.innerHTML = ciudades[respIncorrecta2].nombre;
		btn3.innerHTML = ciudades[respIncorrecta3].nombre;
		btn4.innerHTML = ciudades[respCorrecta].nombre;
	}
}

else if (questionRand==2) {
	question.innerHTML = "What is the nombre of this city?";
	if(rightButton==1){
		btn1.innerHTML = ciudades[respCorrecta].nombre;
		btn2.innerHTML = ciudades[respIncorrecta1].nombre;
		btn3.innerHTML = ciudades[respIncorrecta2].nombre;
